crudini --set /etc/nova/nova.conf database connection mysql+pymysql://nova:healthseq@dev-controller/nova
...
crudini --set /etc/nova/nova.conf DEFAULT my_ip 10.0.2.13
...
crudini --set /etc/nova/nova.conf vnc vncserver_listen 10.0.2.13
crudini --set /etc/nova/nova.conf vnc vncserver_proxyclient_address 10.0.2.13
