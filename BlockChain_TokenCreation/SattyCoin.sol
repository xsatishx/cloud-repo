...
contract SattyCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SattyCoin() {
        ...
        name = "SattyCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SATTY";                                             // Set the symbol for display purposes (CHANGE THIS)
